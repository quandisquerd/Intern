                    ...
                    <aside id="layout-menu" className="layout-menu menu-vertical menu bg-menu-theme">
                        ...
                        <ul className="menu-inner py-1">
                            ...
                            <li className="menu-header small text-uppercase">
                                <span className="menu-header-text">Books</span>
                            </li>
                            <li className="menu-item">
                                <Link to="book"> <a className="menu-link menu-toggle">
                            ...
                            <li className="menu-item">
                                <Link to="book/add">
                                    <a className="menu-link menu-toggle">
                                        ...
                                        <div data-i18n="Authentications">Thêm mới Book</div>
                                    </a>
                                </Link>
                            </li>

                            <li className="menu-header small text-uppercase"><span className="menu-header-text">categories</span></li>

                            <li className="menu-item">
                                <a href="" className="menu-link">
                                    <i className="menu-icon tf-icons bx bx-collection"></i>
                                    <div data-i18n="Basic">Danh sách Category</div>
                                </a>
                            </li>
                            ...
                            <li className="menu-item">
                                <a href="javascript:void(0)" className="menu-link menu-toggle">
                                    ...
                                    <div data-i18n="User interface">Thêm mới Category</div>
                                </a>
                            </li>
                            ...
                            <li className="menu-item">
                                <a href="javascript:void(0);" className="menu-link menu-toggle">
                                    ...
                                    <div data-i18n="Form Elements">Danh sách User</div>
                                </a>
                            </li>
                            <li className="menu-item">
                                <a href="javascript:void(0);" className="menu-link menu-toggle">
                                    <i className="menu-icon tf-icons bx bx-detail"></i>
                                    <div data-i18n="Form Layouts">Thêm mới User</div>
                                </a>
                            </li>
                            <li className="menu-item">
                            ...
                            <li className="menu-header small text-uppercase"><span className="menu-header-text">Order</span></li>
                            <li className="menu-item">
                                <Link to="order">
                                    <a
                                    ...
                                    >
                                        ...
                                        <div data-i18n="Support">Danh Sách Đặt Hàng</div>
                                    </a>
                                </Link>
                            </li>
                            <li className="menu-item">
